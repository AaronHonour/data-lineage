...
-- Create databases (MySQL uses database instead of schema)
CREATE DATABASE IF NOT EXISTS staging;
CREATE DATABASE IF NOT EXISTS analytics;

-- Use staging database for base tables
USE staging;
...
-- Switch to analytics database for views
USE analytics;
...
-- View 6: Daily sales summary (MySQL doesn't support materialized views natively)
